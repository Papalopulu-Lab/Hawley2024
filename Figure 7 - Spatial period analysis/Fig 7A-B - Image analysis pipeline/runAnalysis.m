...
roiWidthInMicrons = 15; %Define the width of the regions of interest (roi) measured in um (15um used in the paper)
...
[spatialPeriodsInd, spatialPeriodsComb, interpFrequency, powerAvg, pk2pk_combined, detrendedSDcomb, coherence, pearsonCombined] = plotResults(allResults, condName, plotGraphs);
