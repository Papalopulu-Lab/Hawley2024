...
%             data.name
            ...
            for r = 1:R
                ...
                %Detrend the mean signal within the roi____________________
                % data.meanSignal{s, z, r} = ...                              %Store the mean signal along the DV axis
                %     mean(data.roiImage{s, z, r}, 2);
                ...
                % windowSize = 80/data.dx;
                % data.detrendLine{s, z, r} = smoothdata(data.meanSignal{s, z, r}, 'gaussian', windowSize);
                ...
                if plotImages == 1
                    ...
                    plot(data.meanSignal{s, z, r}, data.xMicrons{s, z, r})
